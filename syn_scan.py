...
def main():
    ...
    parser.add_option("-p", "--port", type="string", dest="optPorts",
                      help="specify target port separated by comma, can include hyphen, or a file path")
    parser.add_option("-t", "--timeout", type="float", dest="optTimeout",
                      help="specify time out in seconds", default=0.50)
    parser.add_option("-r", "--retry", type="int",
                      dest="optRetry", help="specify retry times", default=1)
    parser.add_option("-o", "--output", type="string", dest="optOutput",
                      help="specify the dir to save results", default='./')
